...
.. glossary::
   ...
   DEA Notebooks
      ...
      Data Cube and xarray. See https://github.com/digitalearthafrica/deafrica-sandbox-notebooks.

   DE Africa Sandbox
      Digital Earth Africa Sandbox, a learning and analysis environment for
      getting started with DE Africa and the Open Data Cube. It includes sample data
   ...
   FC
      ...
      dry grass or hay, and dead leaf litter), and bare ground (soil or rock).
   ...
   JupyterLab
      ...
      JupyterLab is used as an analysis environment on the DEAfrica Sandbox.
   ...
   WOfS
      Water Observations from Space, a Digital Earth Africa product that provides
      images and data showing where water has been seen in by satellites.
